                ...
                <tbody class="table-body_trung">
                    <form action="<?php echo e(Route('manageBooking.seat')); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="checkboxInput inputFltNum<?php echo e($booking->flight_number); ?>" type="checkbox" data-fltNum="<?php echo e($booking->flight_number); ?>" name="bookingId[]" value="<?php echo e($booking->id); ?>" required>
                            </td>
                        </tr>
                        <?php endif; ?>
...
<?php echo $__env->make('airfpt.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\AirFPT\resources\views/manageBooking/show.blade.php ENDPATH**/ ?>