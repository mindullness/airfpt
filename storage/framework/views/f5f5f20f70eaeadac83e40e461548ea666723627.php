...
<div class="container mt-5">
    <div class="row mt-5">
        <div class="col-md-4 seatmap-container">
            ...
            <div data-v-003b1ae4="" class="plane-nose">
                <div data-v-003b1ae4="" class="image"><svg viewBox="0 0 370 268" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div data-v-003b1ae4="" class="plane-tail-wrapper">
                <div data-v-003b1ae4="" class="plane-tail"></div>
            </div>
        </div>
        <div class="col-md-7 offset-md-1">
            <form action="<?php echo e(Route('manageBooking.showseat')); ?>" method="get">
                <table class="table table-tripped table-bordered ">
                    ...
                    <tbody class="table-body">
                        ...
                        <tr>
                            ...
                            <td id="<?php echo e($booking -> id); ?>" class="seatno text-center">
                                <input class="seatInput" type="text" name="<?php echo e($booking->id); ?>">
