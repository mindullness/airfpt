...
<?php $__env->startSection('title', 'passenger information'); ?>
    ...
    <div class="w3-row">
      ...
      <div class="w3-col ">
         ...
         <div class="w3-card-4 w3-margin w3-white">
          <img src="<?php echo e(asset('./img/trucduy/pass_info_cus.jpg')); ?>" alt="Norway" style="width:100%">
          ...
          <div class="w3-container">
            ...
            <div class="w3-row">
              <div class="w3-col m8 s12">
                <p><button class="w3-button w3-padding-large w3-white w3-border"><a href="<?php echo e(Route('airfpt.user.pass_info_cus')); ?>" class="nav-link4"><b>READ MORE »</b></button></p>
              </div>
        ...
        <!-- Blog entry -->
        <div class="w3-card-4 w3-margin w3-white">
          <img src="<?php echo e(asset('./img/trucduy/pass_info_travel1.png')); ?>" style="width:100%" class="mx-auto d-block" alt="">
          <div class="w3-container">
            <h5><span class="w3-opacity">July 22, 2022</span></h5>
          ...
          <div class="w3-container">
            ...
            <div class="w3-row">
              <div class="w3-col m8 s12">
                <p><button class="w3-button w3-padding-large w3-white w3-border"><a href="<?php echo e(Route('airfpt.user.pass_info_travel')); ?>" class="nav-link1"><b>READ MORE »</b></button></p>
              </div>
        ...
        <!-- Blog entry -->
        <div class="w3-card-4 w3-margin w3-white">
          <img src=" <?php echo e(asset('./img/trucduy/pass_info_carr1.jpg')); ?>" style="width:100%">
          <div class="w3-container">
            <h5><span class="w3-opacity">July 22, 2022</span></h5>
          ...
          <div class="w3-container">
            ...
            <div class="w3-row">
              <div class="w3-col m8 s12">
                <p><button class="w3-button w3-padding-large w3-white w3-border"><a href="<?php echo e(Route('airfpt.user.pass_info_carry')); ?>" class="nav-link2"><b>READ MORE »</b></button></p>
              </div>
        ...
        <!-- Blog entry -->
        <div class="w3-card-4 w3-margin w3-white">
          <img src="<?php echo e(asset('./img/trucduy/pass_info_check.jpg')); ?>" alt="Norway" style="width:100%">
          <div class="w3-container">
          ...
          <div class="w3-container">
            ...
            <div class="w3-row">
              <div class="w3-col m8 s12">
                <p><button class="w3-button w3-padding-large w3-white w3-border"><a href="<?php echo e(Route('airfpt.user.pass_info_checked')); ?>" class="nav-link3"><b>READ MORE »</b></button></p>
              </div>
...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway">
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('airfpt.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Myself\xampp\htdocs\airfpt\resources\views/airfpt/user/pass_info.blade.php ENDPATH**/ ?>