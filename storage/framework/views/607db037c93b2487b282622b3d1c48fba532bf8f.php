        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                ...
                <div class="card card-info mt-4">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="<?php echo e(url('admin/routes/postCreate')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="origin" id="origin" class="form-control ">
                                    ...
                                    <option value="<?php echo e($d->iata_code); ?>"><?php echo e($d->iata_code); ?> - <?php echo e($d->name); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Myself\xampp\htdocs\airfpt\resources\views/admin/routes/create.blade.php ENDPATH**/ ?>