...
<?php $__env->startSection('title', 'Select Flight'); ?>
                    ...
                    <div class="outbound_flight">
                        <div class="outbound_title bg-light rounded p-2">
                            ...
                            <span class="">
                                ...
                                <h6 class="m-0 p-0"><?php echo e($flight_list['origin']); ?> (SGN) To <?php echo e($flight_list['destination']); ?> (PQC)</h6>
                            </span>
                        </div>
                        ...
                        <div id="Tue" class="obFlight_tabcontent bg-light">
                            ...
                            <div class="w-75 flt_Info p-2">
                                <div>
                                    <span><?php echo e($flight_list['origin']); ?></span>
                                    <span><?php echo e($flight_list['destination']); ?></span>
                                </div>
                                <div>
                                    <span><?php echo e($flight_list['depart_date']); ?></span>
                                    <span><?php echo e($flight_list['depart_date']); ?></span>
                                </div>
                                <div>
                                    <span>18:15</span>
                    ...
                    <div class="inbound_flight mt-5">
                        <div class="inbound_title bg-light rounded p-2">
                            ...
                            <span class="">
                                ...
                                <h6 class="m-0 p-0"><?php echo e($flight_list['destination']); ?> () To <?php echo e($flight_list['origin']); ?> ()</h6>
                            </span>
                        </div>
                        <!-- panel to show Date & Lowest Price -->
...
<?php echo $__env->make('airfpt.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Myself\xampp\htdocs\airfpt\resources\views/airfpt/booking/flightList.blade.php ENDPATH**/ ?>