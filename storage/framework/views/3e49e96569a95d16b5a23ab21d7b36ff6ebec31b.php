        ...
        <div class="col-lg-3 col-6">        
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <div class="icon">
                        <i class="nav-icon"><img class="align-text-top mt-0 pt-0" src="<?php echo e(asset('img/news-icon.jpg')); ?>" width="66" height="64" alt="" style="border-radius: 12px; opacity:0.9;"></i>
                    </div>
