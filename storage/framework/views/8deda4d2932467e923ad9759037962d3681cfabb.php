...
<?php $__env->startSection('title', 'Search Flight'); ?>
...
<form class=" container  mx-auto" id="bookingForm" method="post" enctype="multipart/form-data" action="<?php echo e(Route('airfpt.booking.flightList')); ?>" role="tabpanel">
...
<?php echo $__env->make('airfpt.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Myself\xampp\htdocs\airfpt\resources\views/airfpt/booking/searchFlight.blade.php ENDPATH**/ ?>