          ...
          <div>
            ...
            <figure class="table" style="text-align:justify;">
              <table>
                <tbody>
                  <tr>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">2 hours before scheduled departure</span>
                    </td>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">check-in and bag drop opened</span>
                    </td>
                  </tr>
                  <tr>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">40 min before scheduled departure</span>
                    </td>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">check-in and bag drop closed</span>
                    </td>
                  </tr>
                  <tr>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">25 min before scheduled departure</span>
                    </td>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">be at your boarding gate</span>
                    </td>
                  </tr>
                  <tr>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">15 min before scheduled departure</span>
                    </td>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">boarding gate closed</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <figure class="table" style="text-align:justify;">
              <table>
                <tbody>
                  <tr>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">3 hours before scheduled departure</span>
                    </td>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">check-in and bag drop opened</span>
                    </td>
                  ...
                  <tr>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">50 min before scheduled departure</span>
                    </td>
                    <td style="border-bottom:1px inset hsl(207, 90%, 54%);border-left:1px inset hsl(207, 90%, 54%);border-right:1px inset hsl(207, 90%, 54%);border-top:1px inset hsl(207, 90%, 54%);">
                      <span style="font-size:17px;">check-in and bag drop closed</span>
                    </td>
              ...
              <ul>
                <li style="text-align:justify;"><span style="font-size:17px;">Due to the safety reasons, the
                  ...
                  <ul>
                    ...
                    <li style="text-align:justify;"><span style="font-size:17px;">Money</span><br><span style="font-size:17px;">Valuable documents</span></li>
...
<?php echo $__env->make('airfpt.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Myself\xampp\htdocs\airfpt\resources\views/airfpt/faqs.blade.php ENDPATH**/ ?>