    ...
    <div class="indexForm container justify-content-center">
        ...
        <div class="tab-content  text-white font-weight-bolder p-2" id="indexFormContent">
            <div role="tabpanel" aria-labelledby="searchFlight-tab" class="tab-pane fade show active" id="searchFlight">
                ...
                <!-- Start Form Booking -->
                <form method="get" role="form" id="searchFlightForm" enctype="multipart/form-data" action="<?php echo e(Route('airfpt.booking.booking')); ?>">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <select name="origin" id="origin" class="form-control ">
                            ...
                            <?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($a->iata_code); ?>"><?php echo e($a->city); ?> (<?php echo e($a->iata_code); ?>) - <?php echo e($a->name); ?></option>
                        ...
                        <!-- Input depart_date -->
                        <input name="depart_date" min="<?php echo e(date('Y-m-d')); ?>" max="" id="depart_date" class="form-control" type="text" placeholder="Day-Month-Year" onfocus="(this.type='date')" onblur="(this.type='date')">
                        <div class="input-group-append">
...
<?php echo $__env->make('airfpt.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\AirFPT\resources\views/airfpt/index.blade.php ENDPATH**/ ?>